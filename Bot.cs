...
namespace Crawler
{
	...
	public class Bot : IDisposable
	{
		...
		private async Task OnReadyAsync(ReadyEventArgs e)
		{
            ...
            await _client.UpdateCurrentUserAsync("Bot");
            await _client.UpdateStatusAsync(new DiscordActivity($"{_client.Guilds.Count} Servers", ActivityType.Watching));
		}
